...
#ifndef __RK616_1280X800_LVDS__
#define __RK616_1280X800_LVDS__


#if  defined(CONFIG_RK610_LVDS) || defined(CONFIG_RK616_LVDS) 
#include "../transmitter/rk610_lcd.h"
// does not exist
//  #include "../transmitter/rk616_lcd.h"
#endif
...
#define S3_FRAC			0x01823014
#define S3_SCL_VST		0x00b
